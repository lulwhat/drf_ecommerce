...
from apps.common.permissions import IsOwnerOrStaffPermission
from apps.common.utils import set_dict_attr
from apps.profiles.models import ShippingAddress, OrderItem, Order
from apps.profiles.serializers import (ProfileSerializer,
                                       ShippingAddressSerializer)
from apps.shop.serializers import CheckItemOrderSerializer, OrderSerializer
...
class ShippingAddressViewID(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if not shipping_address:
            return Response(
                data={"message": "Shipping Address does not exist!"},
                status=404
            )
        serializer = self.serializer_class(data=request.data)
        serializer.is_valid(raise_exception=True)
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return Response(
            data={"message": "Shipping address deleted successfully"},
            status=200
        )
